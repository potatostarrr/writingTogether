  ...
  return(
    <div>
      <Row type="flex" justify="center">
        <h3 className={styles.heading}>Writing Conference</h3>
      </Row>

      <Row className={styles.imageContainer}>
        <Row type="flex" justify="space-around" className={styles.row}>
          <WoodBoard text="Conference 1" to="conferences/1"/>
          <WoodBoard text="Conference 2"/>
        </Row>

        <Row type="flex" justify="space-around" className={styles.row}>
          <WoodBoard text="Conference 3"/>
          <WoodBoard text="Conference 4"/>
        </Row>
        <Row type="flex" justify="space-around" className={styles.row}>
          <WoodBoard text="Conference 5"/>
          <WoodBoard text="Conference 6"/>
        </Row>
